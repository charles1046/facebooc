...
// This will reserve some more spaces to make parser easier to put identifier at
// the end The reserved space might holding 16 char And, this function also
// constrain the end of decoded string is NULL byte
...
// <value> is start at the one byte next to the fist '=', and end at the ena of
// string
